...
- **Name**: Kevin Trinh<!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **Dot Number**: trinh.134<!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **Due Date**: 11/21/2025<!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
The representation I am choosing for AniLibrary is the OSU Map<String, String>. The convention will be something along the lines of rep != null and for (t, g) t!= && g!= null. The correspondence will be something like this = { (t, g) | rep.hasKey(t) and rep.value(t) = g }.
