...
I chose the AniLibrary design because I liked the idea the most out of the other designs and I think it aligns with my personal interests the most. In my spare time I also have coded a website that can be used to search anime so I think it aligns well. Design and time wise, I think that AniLibrary will be the best one for me to code because I feel very comfortable with Map.Pair which I plan to use for it compared to other data structures. They all have about the same difficulty in design I believe so I just chose this one for comfortability.
